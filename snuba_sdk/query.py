...
from snuba_sdk.conditions import BooleanCondition, Condition, ConditionSet
...
class Query:
    ...
    where: Optional[ConditionSet] = None
    having: Optional[ConditionSet] = None
    ...
    def set_where(self, conditions: ConditionSet) -> Query:
    ...
    def set_having(self, conditions: ConditionSet) -> Query:
        if not list_type(conditions, (BooleanCondition, Condition)):
