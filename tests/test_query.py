...
@pytest.mark.parametrize("query", entity_tests)
...
@pytest.mark.parametrize("query", storage_tests)
def test_storage_query(query: Query) -> None:
    query.validate()
